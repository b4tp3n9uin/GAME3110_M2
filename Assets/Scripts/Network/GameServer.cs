...
public class GameServer : MonoBehaviour
{
    ...
    private void OnConnect(NetworkConnection connection)
    {
        ...
        if (new_client.id == "0")
        {
            new_client.color.R = 0.5f;
            new_client.color.G = 0.0f;
            new_client.color.B = 0.0f;
            new_client.position = new Vector3(-5, -5.5f, 0);
        }
        else if (new_client.id == "1")
        {
            new_client.color.R = 0.5f;
            new_client.color.G = 0.0f;
            new_client.color.B = 0.0f;
            new_client.position = new Vector3(10, -5.5f, 0);
        }
        else
        {
            new_client.color.R = 0.0f;
            new_client.color.G = 0.0f;
            new_client.color.B = 0.0f;
            new_client.position = new Vector3(-5, -5.5f, 0);
        }
            ...
            case Commands.INPUT:
                {
                    ...
                    players[clientIndex].transform.Translate(input.input.x, 0, 0);
